...
welp, yes, the title is a little clickbaity. no, i am not taking it back. <img src="/assets/emotes/blehhhh.webp" alt="blehhhh" class="inline-emote">

_"once-in-a-lifetime"_ is the kind of phrase people use when they are either 14 years old or about to oversell something. unfortunately for my dignity, _I mean it_.
...
- weird quest design: most of the time you are just running around until you bump into someone that actually matters. Then you either fight them, talk to them, or _talk to them and fight them_<img src="/assets/emotes/kekw.webp" alt="kekw" class="inline-emote">
- too many dogsh\*t NPC fights. Seriously, what the hell were they thinking
- many bosses make you feel like you are getting murdered by the _[brightest flashbang](https://www.youtube.com/watch?v=Zp2EjsIYIhQ)_ in the Lands Between while looking upon a fricking _Disneyland fireworks show_<img src="/assets/emotes/lookup.webp" alt="lookup" class="inline-emote">

and yet, in spite of all that, **Elden Ring** became the first game to surpass **Skyrim** in my heart.

that is not a light statement for me. I have spent an absurd amount of time in **Skyrim**, and I still go back to it every few months for _emotional support_. <img src="/assets/emotes/sadge.webp" alt="sadge" class="inline-emote"> I also love **Oblivion, ARK, BOTW,** and **RDR2**. As you can already see from the listed names, I love offline single-player games, especially fantasy ones. Open worlds are my thing. Wandering is my thing. Choosing an alternative path and asking, _"wait, what is over there?"_ is very much my thing.

so when I say **Elden Ring** is a _once-in-a-lifetime_ experience, I do not just mean that it is one of the best games I have ever played. I mean it did something I honestly did not think another game could do anymore. It made exploration feel important again. It made the journey matter more than the ending.
...
the funny part is that my life had **not** become calmer. If anything, it had become worse for a game this big (FYI: it took me 120h for the base game, and another 40 for the DLC <img src="/assets/emotes/holy.webp" alt="holy" class="inline-emote">). By then I was working full time as an RnD Lead, and later in the same year I was working two jobs at the same time.

so logically, this should have been the playthrough where **Elden Ring** bounced off me again.

instead, it completely swallowed me.<img src="/assets/emotes/popcat.gif" alt="popcat" class="inline-emote">
...
if I had to point to the first real _"damn"_ moment, it would be right after stepping out of the hero grave into Limgrave.

you leave the opening area, see the Erdtree, meet Varré<img src="/assets/emotes/nobtches.webp" alt="nobtches" class="inline-emote">, and it is **CINEMA**. <img src="/assets/emotes/cinema.webp" alt="cinema" class="inline-emote">

then you get Torrent and realize there is basically no real world boundary in the way most games quietly enforce one. That's it -- from the first moment, you are already on your own, because _this is your story_.
...
well, all is good except the NPC invasion gatekeeping the area. Geez. <img src="/assets/emotes/nopers.webp" alt="nopers" class="inline-emote">

## Elden Ring is not just about gods and war

(this is your **SPOILER ALERT** <img src="/assets/emotes/alert.webp" alt="alert" class="inline-emote">)
...
and Shaman Village deserves a special mention here, because the atmosphere of that place is unreal. The music <img src="/assets/emotes/listening.webp" alt="listening" class="inline-emote"> alone gave me chills. It is one of those rare moments where a game is not just telling you something through lore text or exposition, but through mood, through its soulful music, and through the feeling that something sacred and broken is still lingering in the air.

the Chaos ending <img src="/assets/emotes/aaaa.webp" alt="aaaa" class="inline-emote"> deepened that even further.
...
I'm not [VaatiVidya](https://www.youtube.com/@VaatiVidya), so let's stop talking lore (love the guy btw, definitely go check him out).
...
_I always fight Malenia last_

... no matter which format I play. Even when I did daily randomizer runs (similar to [LilAggy](https://www.twitch.tv/lilaggy)'s weekly randomizer speedrun), even when I did the [French Challenge](https://pastebin.com/9gqDF4cN), even when I did SL1 or no-hit runs.

that is a ritual for me now.

so why does it matter?<img src="/assets/emotes/huhcat.webp" alt="huhcat" class="inline-emote">

you can finish the game. You can do every quest. You can become a god (or a lord, if you will). You can clean up the map, understand the lore, and technically do everything the game asks of you. But if you tell your friend about beating the game, one question always come up: _"Yes, but did you beat Malenia?"_
...
in fact, they made me so mad <img src="/assets/emotes/madge.webp" alt="madge" class="inline-emote"> that I can write an entire blog _"my problems with Elden Ring"_ if I wanted to. But I won't, to save myself from the allegation, and to save you guys from the rant. <img src="/assets/emotes/caught.webp" alt="caught" class="inline-emote">

## do I really mean once-in-a-lifetime?

_absolutely!_ <img src="/assets/emotes/nodders.webp" alt="nodders" class="inline-emote">
...
_\*drumroll\*_ <img src="/assets/emotes/drumroll.webp" alt="drumroll" class="inline-emote">

your precious **tier lists**:

<figure class="tier-list-figure">
  <figcaption>major bosses tier list</figcaption>
  <img src="/assets/major-bosses.png" alt="Elden Ring Major Bosses tier list">
</figure>

<figure class="tier-list-figure">
  <figcaption>smash or pass tier list</figcaption>
  <img src="/assets/smash-or-pass.png" alt="Elden Ring Smash or Pass tier list">
</figure>

no, no, I'm not gonna elaborate on these <img src="/assets/emotes/ghost.webp" alt="ghost" class="inline-emote">
